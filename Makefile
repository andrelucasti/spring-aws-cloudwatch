...
monitoring-docker-local-start: ## Run infrastructure locally
	docker-compose -f local/monitoring/docker-compose.yml up -d --build
monitoring-docker-local-stop: ## Stop infrastructure locally
	docker-compose -f local/monitoring/docker-compose.yml down

monitoring-podman-local-start: ## Run infrastructure locally
	podman-compose -f local/monitoring/docker-compose.yml up -d --build
monitoring-podman-local-stop: ## Stop infrastructure locally
	podman-compose -f local/monitoring/docker-compose.yml down

db-docker-local-start: ## Run database locally
	docker-compose -f local/databases/docker-compose.yml up -d --build
db-docker-local-stop: ## Stop database locally
	docker-compose -f local/databases/docker-compose.yml down

db-podman-local-start: ## Run database locally
	podman-compose -f local/databases/docker-compose.yml up -d --build
db-podman-local-stop: ## Stop database locally
	podman-compose -f local/databases/docker-compose.yml down

aws-podman-local-start: ## Run aws localstack locally
	podman-compose -f local/aws/docker-compose.yml up -d --build
aws-podman-local-stop: ## Stop aws localstack locally
	podman-compose -f local/aws/docker-compose.yml down

aws-docker-local-start: ## Run aws localstack locally
	docker-compose -f local/aws/docker-compose.yml up -d --build
aws-docker-local-stop: ## Stop aws localstack locally
	docker-compose -f local/aws/docker-compose.yml down